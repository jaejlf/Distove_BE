...
public class WebController {
    ...
    @GetMapping("/channel/{channelId}/member")
    public boolean isMember(@PathVariable Long channelId, @RequestParam Long userId) {
        return webService.isMember(channelId, userId);
    }
